		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<ol type="1" class="discharged">
					<li>Пароль учётной записи не хранится в виде текста, при регистрации вычисляется его хэш-функция,
						которая заносится в базу данных.
					</li>
					<li>Указанные пользователем телефон и адрес доставки будут использоваться в качестве контактных
						данных по умолчанию. Позже они могут быть изменены в процессе оформления заказа.
					</li>
					<li>Проверка данных формы выполняется дважды: на стороне пользователя и на стороне сервера.
						Подробности в разделе <a href="<c:url value="/inside#forms" />">проверка форм</a>.
					</li>
				</ol>
			</div>
		</div>
