...
<pre
	style="width: 95%;">заголовок:   Status Code: 200 Ok<br>             Content-Type: application/json; charset=UTF-8<br>тело:        {<br>                "user": "ivan.petrov@yandex.ru",<br>                "items":<br>                [<br>                    {<br>                        "productId": 2,<br>                        "quantity": 1,<br>                        "links": [{<br>                            "rel": "self",<br>                            "href": "http://goformalts.../rest/products/2" }]<br>                    }<br>                ],<br>                "itemsCount": 1,<br>                "productsCost": 4100,<br>                "deliveryCost": 400,<br>                "deliveryIncluded": true,<br>                "totalCost": 4500,<br>                "links":<br>                [<br>                    {<br>                        "rel": "Customer contacts",<br>                        "href": "http://goformalts.../rest/customer/contacts"<br>                    },<br>                    {<br>                        "rel": "Payment",<br>                        "href": "http://goformalts.../rest/cart/payment"<br>                    }<br>                ]<br>             }</pre>
